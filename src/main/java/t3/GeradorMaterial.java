...
public class GeradorMaterial extends convorkBaseVisitor<String> {
    ...
    public String visitProgram(convorkParser.ProgramContext ctx) {
        ...
        return  tag("html","", stringBuilder).toString();
    }
    public StringBuilder tag(String tagName, String classes, StringBuilder content) {
        return content.insert(0, "<" + tagName + "class=\"" + classes + "\">").append("</"+tagName+">");
